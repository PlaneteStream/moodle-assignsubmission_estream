...
class assign_submission_estream extends assign_submission_plugin
	...
	public function get_form_elements($submission, MoodleQuickForm $mform, stdClass $data)
		...
		$itemdesc = "Assignment : " . $this->assignment->get_instance()->name . "rn";
		$itemdesc.= "Course : " . $COURSE->fullname . "rn";
		...
		if ($submission)
			...
			if ($thissubmission)
				...
				$mform->addElement('static', 'currentsubmission', get_string('currentsubmission', 'assignsubmission_estream') , $iframehtml);
				$url.= '&itemcdid=' . $cdid;
				}
			}
		...
		$html.= '</script>';
		$html.= '<div class="block" style="width: 60%; height: 300px;"><div class="header"><div class="title"><h2>' . get_string('upload', 'assignsubmission_estream') . '</h2></div></div>';
